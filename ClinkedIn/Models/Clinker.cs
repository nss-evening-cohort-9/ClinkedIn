...
namespace ClinkedIn.Models
{
    public class Clinker
    {
        ...
        public List<Guid> FriendsList { get; set; } = new ClinkerRepository().GetRandomClinkers();
        public List<Guid> EnemiesList { get; set; } = new ClinkerRepository().GetRandomClinkers();
